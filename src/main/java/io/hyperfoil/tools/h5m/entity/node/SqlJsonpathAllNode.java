...
public class SqlJsonpathAllNode extends NodeEntity {
    ...
    public static SqlJsonpathAllNode parse(String name, String input, Function<String, List<NodeEntity>> nodeFn){
