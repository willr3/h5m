...
@QuarkusMain
@TopCommand
@CommandLine.Command(name="", mixinStandardHelpOptions = true,separator = " ", subcommands={CommandLine.HelpCommand.class, AutoComplete.GenerateCompletion.class, ListCmd.class, AddCmd.class, RemoveCmd.class, AdminCmd.class, LoadLegacyTests.class, LoadLegacyRuns.class, VerifyLegacy.class})
